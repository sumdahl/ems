(function (global, factory) {
  ...
  var functionToString = uncurryThis$k(FunctionPrototype$1.toString);
  ...
  */
  ...
  var engineIsNode = classof$7(global$9.process) === 'process';
  ...
  var functionUncurryThisAccessor = function (object, key, method) {
    try {
      // eslint-disable-next-line es/no-object-getownpropertydescriptor -- safe
      return uncurryThis$e(aCallable$8(Object.getOwnPropertyDescriptor(object, key)[method]));
    } catch (error) { /* empty */ }
  };
  ...
  var bind$7 = uncurryThis$b(uncurryThis$b.bind);
  ...
  var getIterator$2 = function (argument, usingIterator) {
    ...
    if (aCallable$4(iteratorMethod)) return anObject$7(call$8(iteratorMethod, argument));
  ...
  var FORCED$2 = ES3_STRINGS || !arrayMethodIsStrict$2('join', ',');
  ...
  ***************************************************************************** */
  ...
  var IE_BUG = DESCRIPTORS$1 && fails$4(function () {
    // eslint-disable-next-line es/no-object-create -- safe
